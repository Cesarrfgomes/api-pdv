...
export const validarToken = async (req: Request, res:Response, next: NextFunction): Promise<any> =>{
    ...
    try {
        ...
        const usuarioLogado = await knex('TABUSUARIO').where({CODUSUR: id}).first()
